# -*- coding: utf-8 -*-
#
# Agilio Open vSwitch documentation build configuration file, created by
# sphinx-quickstart on Wed Jun 27 22:22:20 2018.
#
...
htmlhelp_basename = 'AgilioOpenvSwitchdoc'
...
man_pages = [
    (master_doc, 'agilioopenvswitch', u'Agilio Open vSwitch Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AgilioOpenvSwitch', u'Agilio Open vSwitch Documentation',
     author, 'AgilioOpenvSwitch', 'One line description of project.',
     'Miscellaneous'),
]
